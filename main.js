(function () {
  ...
  const i18nData = {
    en: {
      ...
      "hero.pre": "WEB STRATEGIST",
      "hero.title.p1": "WEBSITES", "hero.title.p2": "THAT", "hero.title.p3": "BRING CLIENTS",
      "hero.sub": "I help businesses turn Google searches into real clients with fast, professional websites built to convert.",
      "about.label": "About Me",
      "about.statement": "Most businesses don’t have a website… and don’t realize how many clients they lose because of it.",
      ...
      "values.v1": "A website designed to bring real clients, not just look nice", "values.v2": "Simple communication (Arabic / Français / English)", "values.v3": "Full ownership, your website is 100% yours",
      ...
      "loss.p2": "“Dentist near me” · “Best clinic in my city” · “Emergency appointment”",
      ...
      "loss.closing": "A simple, well-built website can change that in days.",

      "services.title": "How I Help You Grow",
      "services.web.title": "Business Websites", "services.web.desc": "Professional websites that make your business visible on Google and turn visitors into clients.", "services.web.price": "270 USD",
      "services.ecom.title": "Online Store", "services.ecom.desc": "Sell your products online with a simple, secure buying experience.", "services.ecom.price": "230 USD",
      "services.lp.title": "Client Acquisition Page", "services.lp.desc": "A single powerful page designed to bring you new clients quickly, ideal for clinics & local services.", "services.lp.price": "190 USD",
    ...
    fr: {
      ...
      "values.v1": "Un site qui attire des clients, pas juste joli", "values.v2": "Communication simple", "values.v3": "Vous êtes propriétaire à 100%",
      ...
      "loss.p2": "“Dentiste près de moi” · “Meilleure clinique à Alger” · “Urgence dentaire”",
      ...
      "services.web.title": "Site Web Professionnel", "services.web.desc": "Rendez votre business visible sur Google et transformez les visiteurs en clients.", "services.web.price": "270 USD",
      "services.ecom.title": "Boutique en ligne", "services.ecom.desc": "Vendez vos produits facilement avec une expérience fluide.", "services.ecom.price": "230 USD",
      "services.lp.title": "Page pour attirer des clients", "services.lp.desc": "Une page simple et efficace pour générer des clients rapidement (idéal cliniques, services).", "services.lp.price": "190 USD",
